  ...
  return (
    <div>
      ...
      <Excellence 
        ...
        listofContent={['Top Rankers in admission cum scholarship test', 'Talented students with poor financial status', 'Full time library facility with a wide range of books by reputed authors and publication', 'Affordable hostel facility is provided by the academy for the students']}
        image={image2}
      />
      <Contact />
    </div>
